...
public class Strings {
    public static final String FILE_SHARED_BY = "File shared by: ";

    public static final String UPLOAD = "Upload";
    public static final String ERROR_READING = "Error reading uploaded file.";
    public static final String PLEASE_UPLOAD_VALID_FILE = "Please upload a valid file.";
    public static final String SUCCESSFULLY_UPLOADED = "Successfully uploaded. File is now being shared.";
    ...
    public static final String DID_NOT_DOWNLOAD = "Did not download file.";
